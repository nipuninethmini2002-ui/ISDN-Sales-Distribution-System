...
// DELIVERY PERSON → only own delivery history (FIXED)
if($role === 'Delivery_Person'){

    // 🔥 MAP user_id → delivery_person_id
    $map = $conn->prepare("
...
// CUSTOMER → only own orders’ delivery history
...
// ADMIN & RDC_STAFF → see all deliveries (no extra filter)
