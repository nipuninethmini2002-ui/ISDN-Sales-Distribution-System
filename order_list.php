...
include 'db.php';
$customer_id = $_SESSION['customer_id']; // Logged in customer ID
?>
...
<div class="container">
    ...
    <?php
    // Display error message if redirected from delivery.php
