<?php
// ========================
// place_order.php (Fixed Branch Issue)
// ========================
...
$branch = $_SESSION['branch']; // ✅ use signup branch
...
// --- Insert order with branch included ---
...
$_SESSION['recent_order'] = [
    ...
    'name' => $product['name'],
    'price' => $product['price'],
    'branch' => $branch // ✅ include branch in session
];
...
// ========================
// Fetch customer email & username correctly using JOIN
// ========================
...
if(!empty($email_to)){
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'isdnsystem@gmail.com'; // Your Gmail
        $mail->Password   = 'webnqrkahihtfato';     // Your Gmail App Password
...
<div class="container">
    ...
    <table>
        ...
        <tr><th>Branch</th><td><?php echo htmlspecialchars($branch); ?></td></tr> <!-- ✅ show branch -->
