...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($stmt->num_rows === 1){
        ...
        if(password_verify($password, $db_password)){
            ...
            // --------------------------
            // 6️⃣ Delivery Person session setup
            // --------------------------
            if($role === 'Delivery_Person'){
                // delivery_person table check
                ...
                // set first assigned order (if any)
                ...
                if($order_result && $order_result->num_rows > 0){
                    ...
                    $_SESSION['current_order_id'] = 0; // no assigned order
                }
            }

            // --------------------------
            // 7️⃣ Customer session setup
            // --------------------------
            if($role === 'Customer'){
